    ...
    <>
      <main className="w-full h-screen flex flex-col items-center justify-center px-4 bg-slate-50">
        <div className="max-w-sm w-full text-gray-600 space-y-2 bg-white px-10 my-5 rounded-md">
          ...
          <button className="w-full flex items-center justify-center gap-x-3 py-2 border rounded-lg text-sm font-medium hover:bg-gray-50 duration-150 active:bg-gray-100">
            <svg
              className="w-5 h-5"
              viewBox="0 0 48 48"
              fill="none"
